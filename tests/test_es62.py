...
from src.m10_package.coordinate_student import punti_student, linee_student


def test_crea_punto():
    """Test creazione di un punto."""
    p = punti_student.crea_punto(3.0, 4.0)
    assert p["x"] == 3.0
    assert p["y"] == 4.0
...
def test_info_punto():
    ...
    p = punti_student.crea_punto(2.5, 3.5)
    info = punti_student.info_punto(p)
    assert info == "(2.5, 3.5)"


def test_distanza_tra_punti():
    """Test calcolo distanza tra due punti."""
    p1 = punti_student.crea_punto(0.0, 0.0)
    p2 = punti_student.crea_punto(3.0, 4.0)
    
    # Triangle 3-4-5, distanza dovrebbe essere 5.0
    distanza = punti_student.distanza_tra_punti(p1, p2)
    assert distanza == 5.0


def test_distanza_tra_punti_stessi():
    """Test distanza quando i punti sono uguali."""
    p1 = punti_student.crea_punto(1.0, 1.0)
    p2 = punti_student.crea_punto(1.0, 1.0)
...
def test_distanza_tra_punti_negativa():
    ...
    p1 = punti_student.crea_punto(-3.0, -4.0)
    p2 = punti_student.crea_punto(0.0, 0.0)
...
def test_crea_linea():
    ...
    linea = linee_student.crea_linea(p1, p2)
    assert linea["p1"] == p1
    assert linea["p2"] == p2
...
def test_lunghezza_linea():
    ...
    linea = linee_student.crea_linea(p1, p2)
    lungh = linee_student.lunghezza_linea(linea)
    assert lungh == 5.0
...
def test_punto_medio_negativi():
    ...
    p1 = punti_student.crea_punto(-2.0, -2.0)
    p2 = punti_student.crea_punto(2.0, 2.0)
...
def test_info_linea():
    ...
    linea = linee_student.crea_linea(p1, p2)
    info = linee_student.info_linea(linea)
...
def test_linea_verticale():
    ...
    p1 = punti_student.crea_punto(0.0, 0.0)
    p2 = punti_student.crea_punto(0.0, 5.0)
...
def test_linea_orizzontale():
    ...
    p1 = punti_student.crea_punto(0.0, 3.0)
    p2 = punti_student.crea_punto(4.0, 3.0)
