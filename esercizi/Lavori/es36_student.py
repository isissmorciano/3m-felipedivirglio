...
# ## Esempio
# Se il dizionario iniziale è {"Mario": 10}, l'utente inserisce "Mario" e 15, diventa {"Mario": 15}. 
# Se inserisce "Anna" e 12, diventa {"Mario": 10, "Anna": 12}:
...
if nome in punteggi_dict:
    punteggi_dict[nome] = punteggio
else:
    punteggi_dict[nome] = punteggio
